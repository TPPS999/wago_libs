# WagoSysModule_75x_562 v1.9.4.0

## Overview
WAGO PLC library providing WagoSysModule_75x_562 functionality.
...
```iec
VAR
    fbFbModule_75x_562_dynConfig: FbModule_75x_562_dynConfig;
END_VAR

// Basic function block usage
fbFbModule_75x_562_dynConfig(
    // Configure inputs as needed
);

// Check status
IF fbFbModule_75x_562_dynConfig.xValid THEN
    // Operation successful
END_IF

IF fbFbModule_75x_562_dynConfig.xError THEN
    // Handle error
END_IF
```
